...
_columns = ['Currents', 'IsDelta', 'MeteredElement', 'MeteredTerminal', 'Name', 'PctError', 'ReverseDelta', 'Weight', 'kvar', 'kVS', 'kVBase', 'kW']
__all__ = ['Reset', 'ResetAll', 'AllNames', 'Count', 'Currents', 'First', 'IsDelta', 'MeteredElement', 'MeteredTerminal', 'Name', 'Next', 'PctError', 'ReverseDelta', 'Weight', 'kvar', 'kVS', 'kVBase', 'kW']
