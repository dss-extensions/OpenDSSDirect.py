...
_columns = ['IsBlown', 'Delay', 'MonitoredObj', 'MonitoredTerm', 'Name', 'NumPhases', 'RatedCurrent', 'SwitchedObj', 'SwitchedTerm', 'TCCCurve', 'Idx']
__all__ = ['Close', 'IsBlown', 'Open', 'AllNames', 'Count', 'Delay', 'First', 'MonitoredObj', 'MonitoredTerm', 'Name', 'Next', 'NumPhases', 'RatedCurrent', 'SwitchedObj', 'SwitchedTerm', 'TCCCurve', 'Idx']
