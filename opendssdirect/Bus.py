...
_columns = ['ZscRefresh', 'Coorddefined', 'CplxSeqVoltages', 'Cust_Duration', 'Cust_Interrupts', 'Distance', 'Int_Duration', 'Isc', 'Lambda', 'N_Customers', 'N_interrupts', 'Name', 'Nodes', 'NumNodes', 'SectionID', 'SeqVoltages', 'TotalMiles', 'VLL', 'VMagAngle', 'Voc', 'Voltages', 'YscMatrix', 'Zsc0', 'Zsc1', 'ZscMatrix', 'kVBase', 'puVLL', 'puVmagAngle', 'PuVoltage', 'X', 'Y']
__all__ = ['GetUniqueNodeNumber', 'ZscRefresh', 'Coorddefined', 'CplxSeqVoltages', 'Cust_Duration', 'Cust_Interrupts', 'Distance', 'Int_Duration', 'Isc', 'Lambda', 'N_Customers', 'N_interrupts', 'Name', 'Nodes', 'NumNodes', 'SectionID', 'SeqVoltages', 'TotalMiles', 'VLL', 'VMagAngle', 'Voc', 'Voltages', 'YscMatrix', 'Zsc0', 'Zsc1', 'ZscMatrix', 'kVBase', 'puVLL', 'puVmagAngle', 'PuVoltage', 'X', 'Y']
