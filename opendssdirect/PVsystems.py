...
_columns = ['Irradiance', 'Name', 'pf', 'RegisterNames', 'RegisterValues', 'Idx', 'kVARated', 'kW', 'kvar']
__all__ = ['AllNames', 'Count', 'First', 'Irradiance', 'Name', 'Next', 'pf', 'RegisterNames', 'RegisterValues', 'Idx', 'kVARated', 'kW', 'kvar']
