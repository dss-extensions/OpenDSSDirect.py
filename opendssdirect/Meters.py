...
_columns = ['AllBranchesInZone', 'AllEndElements', 'AllocFactors', 'AvgRepairTime', 'CalcCurrent', 'CountBranches', 'CountEndElements', 'CustInterrupts', 'FaultRateXRepairHrs', 'MeteredElement', 'MeteredTerminal', 'Name', 'NumSectionBranches', 'NumSectionCustomers', 'NumSections', 'OCPDeviceType', 'PeakCurrent', 'RegisterNames', 'RegisterValues', 'SAIDI', 'SAIFI', 'SAIFIkW', 'SectSeqidx', 'SectTotalCust', 'SeqListSize', 'SequenceList', 'SumBranchFltRates', 'TotalCustomers', 'Totals']
__all__ = ['CloseAllDIFiles', 'DoReliabilityCalc', 'OpenAllDIFiles', 'Reset', 'ResetAll', 'Sample', 'SampleAll', 'Save', 'SaveAll', 'SetActiveSection', 'AllBranchesInZone', 'AllEndElements', 'AllNames', 'AllocFactors', 'AvgRepairTime', 'CalcCurrent', 'Count', 'CountBranches', 'CountEndElements', 'CustInterrupts', 'DIFilesAreOpen', 'FaultRateXRepairHrs', 'First', 'MeteredElement', 'MeteredTerminal', 'Name', 'Next', 'NumSectionBranches', 'NumSectionCustomers', 'NumSections', 'OCPDeviceType', 'PeakCurrent', 'RegisterNames', 'RegisterValues', 'SAIDI', 'SAIFI', 'SAIFIkW', 'SectSeqidx', 'SectTotalCust', 'SeqListSize', 'SequenceList', 'SumBranchFltRates', 'TotalCustomers', 'Totals']
