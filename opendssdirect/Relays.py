...
_columns = ['MonitoredObj', 'MonitoredTerm', 'Name', 'SwitchedObj', 'SwitchedTerm', 'Idx']
__all__ = ['AllNames', 'Count', 'First', 'MonitoredObj', 'MonitoredTerm', 'Name', 'Next', 'SwitchedObj', 'SwitchedTerm', 'Idx']
