...
_columns = ['AccumulatedL', 'FaultRate', 'FromTerminal', 'IsShunt', 'Lambda', 'Name', 'NumCustomers', 'ParentPDElement', 'RepairTime', 'SectionID', 'TotalMiles', 'TotalCustomers', 'PctPermanent']
__all__ = ['AccumulatedL', 'Count', 'FaultRate', 'First', 'FromTerminal', 'IsShunt', 'Lambda', 'Name', 'Next', 'NumCustomers', 'ParentPDElement', 'RepairTime', 'SectionID', 'TotalMiles', 'TotalCustomers', 'PctPermanent']
