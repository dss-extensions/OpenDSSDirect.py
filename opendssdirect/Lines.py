...
_columns = ['Bus1', 'Bus2', 'C0', 'C1', 'CMatrix', 'EmergAmps', 'Geometry', 'Length', 'LineCode', 'Name', 'NormAmps', 'NumCust', 'Parent', 'Phases', 'R0', 'R1', 'Rg', 'Rho', 'RMatrix', 'Spacing', 'TotalCust', 'Units', 'X0', 'X1', 'Xg', 'XMatrix', 'Yprim']
__all__ = ['New', 'AllNames', 'Bus1', 'Bus2', 'C0', 'C1', 'CMatrix', 'Count', 'EmergAmps', 'First', 'Geometry', 'Length', 'LineCode', 'Name', 'Next', 'NormAmps', 'NumCust', 'Parent', 'Phases', 'R0', 'R1', 'Rg', 'Rho', 'RMatrix', 'Spacing', 'TotalCust', 'Units', 'X0', 'X1', 'Xg', 'XMatrix', 'Yprim']
