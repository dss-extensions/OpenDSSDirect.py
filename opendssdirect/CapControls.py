...
_columns = ['CTRatio', 'Capacitor', 'DeadTime', 'Delay', 'DelayOff', 'Mode', 'MonitoredObj', 'MonitoredTerm', 'Name', 'OFFSetting', 'ONSetting', 'PTRatio', 'UseVoltOverride', 'Vmax', 'Vmin']
__all__ = ['Reset', 'AllNames', 'CTRatio', 'Capacitor', 'Count', 'DeadTime', 'Delay', 'DelayOff', 'First', 'Mode', 'MonitoredObj', 'MonitoredTerm', 'Name', 'Next', 'OFFSetting', 'ONSetting', 'PTRatio', 'UseVoltOverride', 'Vmax', 'Vmin']
