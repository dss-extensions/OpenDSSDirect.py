...
_columns = ['Action', 'Delay', 'IsLocked', 'Name', 'NormalState', 'State', 'SwitchedObj', 'SwitchedTerm']
__all__ = ['Reset', 'Action', 'AllNames', 'Count', 'Delay', 'First', 'IsLocked', 'Name', 'Next', 'NormalState', 'State', 'SwitchedObj', 'SwitchedTerm']
