...
_columns = ['AllPropertyNames', 'AllVariableNames', 'AllVariableValues', 'BusNames', 'CplxSeqCurrents', 'CplxSeqVoltages', 'Currents', 'CurrentsMagAng', 'DisplayName', 'EmergAmps', 'Enabled', 'EnergyMeter', 'GUID', 'Handle', 'HasOCPDevice', 'HasSwitchControl', 'HasVoltControl', 'Losses', 'Name', 'NodeOrder', 'NormalAmps', 'NumConductors', 'NumControls', 'NumPhases', 'NumProperties', 'NumTerminals', 'OCPDevIndex', 'OCPDevType', 'PhaseLosses', 'Powers', 'Residuals', 'SeqCurrents', 'SeqPowers', 'SeqVoltages', 'Voltages', 'VoltagesMagAng', 'YPrim']
__all__ = ['Close', 'Controller', 'Variable', 'Variablei', 'IsOpen', 'Open', 'AllPropertyNames', 'AllVariableNames', 'AllVariableValues', 'BusNames', 'CplxSeqCurrents', 'CplxSeqVoltages', 'Currents', 'CurrentsMagAng', 'DisplayName', 'EmergAmps', 'Enabled', 'EnergyMeter', 'GUID', 'Handle', 'HasOCPDevice', 'HasSwitchControl', 'HasVoltControl', 'Losses', 'Name', 'NodeOrder', 'NormalAmps', 'NumConductors', 'NumControls', 'NumPhases', 'NumProperties', 'NumTerminals', 'OCPDevIndex', 'OCPDevType', 'PhaseLosses', 'Powers', 'Residuals', 'SeqCurrents', 'SeqPowers', 'SeqVoltages', 'Voltages', 'VoltagesMagAng', 'YPrim']
