...
Here's an example of how to use multiple DSS instances and multi-threading, directly in Python. This would be recommended for most uses instead of the internal/classic [Parallel interface](opendssdirect.Parallel.IParallel).

<!-- TODO: update link to the website when ready -->

[General recommendations apply](https://github.com/dss-extensions/dss-extensions/blob/main/multithreading.md), like using a good memory allocator on Linux.
